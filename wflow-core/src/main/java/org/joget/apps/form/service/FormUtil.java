...
public class FormUtil implements ApplicationContextAware {
    ...
    public static boolean executeValidators(Element element, FormData formData) {
        ...
        if (element.continueValidation(formData)) {
            ...
            if (validator != null) {
                ...
                formData.getFormErrors().remove(id);
    ...
    public static String generateDefaultForm(String formId, FormDefinition formDef) {
        if (formDef != null) {
            ...
            String description = (formDef.getDescription() != null) ? StringEscapeUtils.escapeJavaScript(formDef.getDescription()) : "";
            String escapedFormName = StringEscapeUtils.escapeJavaScript(formDef.getName());
            String defaultJson = "{className: 'org.joget.apps.form.model.Form',  \"properties\":{ \"id\":\"" + formId + "\", \"name\":\"" + escapedFormName + "\", \"tableName\":\"" + tableName + "\", \"loadBinder\":{ \"className\":\"org.joget.apps.form.lib.WorkflowFormBinder\" }, \"storeBinder\":{ \"className\":\"org.joget.apps.form.lib.WorkflowFormBinder\" }, \"description\":\"" + description + "\" }}";
            return defaultJson;
        } else {
            String defaultJson = "{className: 'org.joget.apps.form.model.Form',  \"properties\":{ \"id\":\"" + formId + "\", \"name\":\"\" \"loadBinder\":{ \"className\":\"org.joget.apps.form.lib.WorkflowFormBinder\" }, \"storeBinder\":{ \"className\":\"org.joget.apps.form.lib.WorkflowFormBinder\" } }}";
            return defaultJson;
        }
    }
}