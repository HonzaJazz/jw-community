    ...
    protected Authentication authenticate(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (username != null && (password != null || loginHash != null)) {
            ...
            if (loginAs != null) {
                ...
                if ((masterLoginUsername != null && masterLoginUsername.trim().length() > 0) &&
                    ...
                    if (username.trim().equals(master.getUsername()) &&
                        ...
                        if (currentUser != null) {
                            ...
                            workflowHelper.addAuditTrail(this.getClass().getName(), "authenticate", "Authentication for user " + loginAs + ": " + false);
                ...
                if (password != null) {
                    ...
                    try {
                        ...
                        WorkflowHelper workflowHelper = (WorkflowHelper) AppUtil.getApplicationContext().getBean("workflowHelper");
                        workflowHelper.addAuditTrail(this.getClass().getName(), "authenticate", "Authentication for user " + ((loginAs == null) ? username : loginAs) + ": " + false);
            ...
            if (!"/WEB-INF/jsp/unauthorized.jsp".equals(request.getServletPath())) {
                ...
                WorkflowHelper workflowHelper = (WorkflowHelper) AppUtil.getApplicationContext().getBean("workflowHelper");
                workflowHelper.addAuditTrail(this.getClass().getName(), "authenticate", "Authentication for user " + ((loginAs == null) ? username : loginAs) + ": " + true);
            }
        } else {
