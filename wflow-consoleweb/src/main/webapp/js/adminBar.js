var AdminBar = {
    ...
    initAdminBar: function() {
        ...
        $(document).keyup(function (e) {
            ...
            if(e.which === 49 && AdminBar.isCtrlKeyPressed) { // CTRL+1
                AdminBar.showAdminBar();
                $("#adminBarButtons a.adminBarButton:eq(0)").trigger("click");
		return false;
            }
            if(e.which === 50 && AdminBar.isCtrlKeyPressed) { // CTRL+2
                AdminBar.showAdminBar();
                $("#adminBarButtons a.adminBarButton:eq(1)").trigger("click");
		return false;
            }
            if(e.which === 51 && AdminBar.isCtrlKeyPressed) { // CTRL+3
                AdminBar.showAdminBar();
                $("#adminBarButtons a.adminBarButton:eq(2)").trigger("click");
		return false;
            }
            if(e.which === 52 && AdminBar.isCtrlKeyPressed) { // CTRL+4
                AdminBar.showAdminBar();
