...
<html>
    <head>
        ...
        <title><fmt:message key="adminBar.label.userview"/>: ${userview.name} - <fmt:message key="ubuilder.title"/></title>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/js/chosen/chosen.min.css" />
